...
extern void bsp_delayms(u16 counter);
extern void fun_usartSend(USART_TypeDef *com ,u8 data);
extern u8 fun_usartRec(USART_TypeDef *com);
extern u8 fun_spiSwap(SPI_TypeDef* spix,u8 data);
extern void bsp_delay100ms(u16 counter);
